...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429892031-opv08gsafbb-creating-jira-ticket__01-click-create-and-select-create-jira-ticket.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Click Create and select Create Jira Ticket from the dropdown" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429893762-wp9dmq2m4g-creating-jira-ticket__02-optionally-select-a-due-date-and-any.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Optionally, select a Due Date and any additional fields using Select optional fields" caption=" " />
5. Select the **Enable Ticket Automation** checkbox if you want Scrut to automatically create a new Jira ticket each time this artifact's status moves to a non-compliant status. See [Enable Jira Ticket Automation for more details](/v1/docs/creating-jira-ticket#jira-ticket-automation).
6. For evidence tasks only: select the **"Also sync attachments embedded in descriptions and comments"** checkbox to have Scrut import inline images and files from Jira ticket descriptions and comments into the linked evidence task. See [Sync Jira Attachments to Evidence Tasks for more details](/v1/docs/creating-jira-ticket#sync-jira-attachments-to-evidence-tasks).
7. Click **Create**.
8. Watch for the success notification.

The ticket is now live in your Jira workspace.

<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429895440-fcjsplj131-creating-jira-ticket__03-the-ticket-is-now-live-in-your-jira-workspace.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="The ticket is now live in your Jira workspace" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429897217-l07xsvl01td-creating-jira-ticket__04-when-creating-a-ticket-from-the-cloud-module.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="When creating a ticket from the Cloud module, Scrut automatically includes the AI code fix in the description" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429898911-kjmfespf24-creating-jira-ticket__05-click-create-jira-tickets.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Click Create Jira Tickets" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429900636-1bo034ielmn-creating-jira-ticket__07-when-linking-an-existing-jira-ticket-in-the.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="When linking an existing Jira ticket: In the Link Ticket modal, select the Enable Ticket Automation checkbox" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429902402-xtc1rwsp7r8-creating-jira-ticket__08-attachments-from-linked-jira-tickets-will.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Attachments from linked Jira tickets will now automatically sync to the corresponding evidence tasks" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429904320-3y3q8wuk0s3-creating-jira-ticket__09-in-the-create-jira-ticket-modal-select-the.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="In the Create Jira Ticket modal, select the Also sync attachments embedded in descriptions and comments" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429905902-itsh115lt1-creating-jira-ticket__10-the-integration-between-scrut-and-jira-is.gif?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="The integration between Scrut and Jira is bidirectional and syncs in real time" caption=" " />

## FAQs and Troubleshooting

<ExpandableGroup>

<Expandable title="1: How do I unlink a Jira ticket in Scrut?" default-open="false">
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786429907616-asv3zaiej-creating-jira-ticket__11-open-the-artifact-scroll-to-the-tickets-jira.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Open the artifact, scroll to the Tickets (Jira) tab, and click the unlink icon next to the ticket you want to" caption=" " />

</Expandable>

<Expandable title="2: Can I add multiple Jira tickets to the same artifact?" default-open="false">
...
<Expandable title="3: Why isn't the due date visible in Jira?" default-open="false">
...
<Expandable title="4: Can I edit the ticket title and description when creating multiple tickets at once?" default-open="false">
...
<Expandable title="5: Will Scrut sync images embedded in Jira descriptions and comments?" default-open="false">
...
<Expandable title="6: Does enabling Ticket Automation affect tickets that are already linked?" default-open="false">
