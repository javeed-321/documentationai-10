...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786430640982-efvlb5rf4o-integrating-hexnode__01-copy-your-api-key-and-store-it-securely.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Copy your API Key and store it securely" caption=" " />
...
<Expandable title="1: What happens if a device is removed from Hexnode?" default-open="false">

The device record will be marked as inactive or removed from Scrut during the next sync.

</Expandable>

<Expandable title="2: Can I sync historical data?" default-open="false">

The integration syncs the current device state as reported by Hexnode. Historical data is not available through the API.

</Expandable>

<Expandable title="3: What if an employee has multiple devices?" default-open="false">
...
<Expandable title="4: Will Scrut fetch BYOD (Bring Your Own Device) data?" default-open="false">

Yes, any device enrolled in Hexnode will be synced to Scrut, including personal devices enrolled under BYOD policies.

</Expandable>

<Expandable title="5: What happens if the API key is regenerated?" default-open="false">
