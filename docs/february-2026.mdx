...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786432188985-151nbu278sn-february-2026__01-scrut-teammates-leverages-ai-to-evaluate.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Scrut Teammates leverages AI to evaluate policy alignment and surface gaps, with guidance on what to update" caption=" " />
...
<Video uid="4e274810-2b0d-4e49-ac7e-f5f14e67ba05" src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786442947125-h8np18sda4i-02-improved-policy-import-feature.mp4" render-type="video" width="560" height="315" controls="true" allow-full-screen="true" />
<Callout kind="info">
...
<Video uid="481d50ca-83e3-4770-96d3-373c97e63fb9" src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786443155987-hqo9h487ypb-03-automating-policy-version-updates.mp4" render-type="video" width="560" height="315" controls="true" allow-full-screen="true" />
<Callout kind="info">
...
<Callout kind="info">
  Learn more: [Detect Evidence Gaps with Scrut Teammates](https://help.scrut.io/docs/automated-evidence-checker)
</Callout>
...
<Video uid="d27d9276-580c-4cc2-b3ce-e6bf658cdf34" src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786443159441-sy5iev0rntc-04-trust-center-subscribe-to-updates.mp4" render-type="video" width="560" height="315" controls="true" allow-full-screen="true" />
<Callout kind="info">
  Learn more: [Enable Trust Portal Subscriptions](https://help.scrut.io/docs/turn-on-subscriptions-to-trust-portal-updates)
</Callout>
...
<Video uid="4cc28ce4-a782-4eba-9013-20e45542b150" src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786443165392-rrec53cdavi-05-accelerate-vendor-reviews-with-auto-fetched.mp4" render-type="video" width="560" height="315" controls="true" allow-full-screen="true" />
<Callout kind="info">
...
<Video uid="0441d6d9-7552-48a5-ba00-1da4a5bfd85d" src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786443169046-iq12k4ipjko-06-streamline-risk-mitigation-tasks-with.mp4" render-type="video" width="560" height="315" controls="true" allow-full-screen="true" />
<Callout kind="info">
  Learn more: [Mitigation Task Approval Workflow](https://help.scrut.io/docs/mitigation-task-approval-workflow)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786432190944-icbq2canpz-february-2026__07-the-my-tasks-tab-in-the-task-center.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="The My Tasks tab in the Task Center consolidates every task assigned to you in one view, with context on the" caption=" " />
...
- **Mandatory vendor questionnaire attachments:** [Mark attachments mandatory](https://help.scrut.io/docs/adding-vendor-questionnaire-manually#step-2-add-questions-to-the-template) for questions, so vendors cannot submit without uploads such as policies, certifications, or reports.
- **Questionnaire smart import field selection:** During [Questionnaire Import](https://help.scrut.io/docs/bulk-importing-template), explicitly map which columns are questions and which are answers (including multi-field selections).
- **Import your risk register without adhering to a strict template:** Previously, teams had to download the risk import template, reshape their register to match, and upload again. Scrut has simplified the [risk register import](https://help.scrut.io/docs/adding-a-new-risk#3-import-risks-in-bulk) into three easy steps: upload your file, map column headers to Scrut fields, and preview the mapped data before saving.
...
- **Integration-synced vendors:** [Integration-synced vendors](https://help.scrut.io/docs/added-via-integrations) can be archived but not deleted, which prevents them from reappearing after sync.
- **Editable evidence templates:** You can now [edit evidence templates](https://help.scrut.io/docs/using-evidence-templates#editing-the-sample-template) directly within Scrut to match your specific organizational requirements.
