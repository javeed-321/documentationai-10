---
title: "Integrate Tenable"
description: "Learn how to connect your Tenable account with Scrut for end-to-end vulnerability tracking."
---
...
| Scrut Field | Tenable Field | Notes |
| --- | --- | --- |
| Vulnerability name/title | plugin.name |  |
| Status | state, severity_modification_type | - OPEN/REOPENED map to Open - FIXED maps to Closed - accepted maps to Acknowledged |
| Severity level | severity | critical/high/medium/low map to Critical/High/Medium/Low; info findings are excluded by default |
| Source integration | Set to Tenable |  |
| CVE ID | plugin.cve | Array is converted to a comma-separated string |
| CVSS Score | plugin.cvss3_base_score (or plugin.cvss_base_score) | CVSSv3 is used where available, with CVSSv2 as fallback |
| Fix availability | plugin.has_patch | true maps to Available, false maps to Not Available |
| First Seen date | first_found | Converted to Scrut date format |
| Last Scanned On date | last_found | Converted to Scrut date format |
| Description | plugin.description |  |
| How to Fix | plugin.solution | Reference URLs appended where available |
| Report Link | Constructed URL | Links back to the finding in Tenable.io |

### Asset Data

| Scrut Field | Tenable Field | Notes |
| --- | --- | --- |
| Asset identifier | asset.fqdn, asset.hostname, or asset.ipv4 | Priority order is FQDN, then hostname, then IPv4 |
| Asset type | asset.device_type or plugin.family | Captured as a tag |
| Tags | asset.tags plus derived tags | Includes source, asset type, plugin family, VPR score, and exploit availability |
| Asset status | Derived from the vulnerability state | If the related vulnerability is Fixed, the asset may be marked remediated; otherwise, it shows as Active |
...
#### Method 1: Using a dedicated service account (Recommended)
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431359980-f6xxz7x7a9v-integrating-tenable__01-under-vulnerability-scanners-find-tenable.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Under Vulnerability Scanners, find Tenable and click Integrate" caption=" " />
4. Enter the **Access Key** and **Secret Key** you generated in Step 1.
5. Click **Submit**.

<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431361776-njhixkq6cph-integrating-tenable__02-click-submit.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Click Submit" caption=" " />
6. Confirm the integration status shows as Connected.

<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431363725-0doey96e5xun-integrating-tenable__03-confirm-the-integration-status-shows-as.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Confirm the integration status shows as Connected" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431365772-havhg41iqga-integrating-tenable__04-navigate-to-vulnerabilities-third-party.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Navigate to Vulnerabilities → Third-Party Scans and filter by Source: Tenable to view synced findings" caption=" " />
...
<Expandable title="1: What happens if I regenerate my Tenable API keys after connecting?" default-open="false">
...
<Expandable title="2: Can Scrut sync findings from a custom or FedRAMP Tenable instance?" default-open="false">
...
<Expandable title="3: How does Scrut handle vulnerabilities that are marked as risk-accepted in Tenable?" default-open="false">

These are mapped to an Acknowledged status in Scrut.

</Expandable>

<Expandable title="4: Does Scrut retain Tenable's VPR score and threat-intel data?" default-open="false">
...
- [Integrate SonarCloud](/integrating-sonarcloud.md)
- [Integrate Sentry](/integrating-sentry.md)
- [Integrate Microsoft Defender Endpoint](/integrating-microsoft-defender-endpoint.md)
