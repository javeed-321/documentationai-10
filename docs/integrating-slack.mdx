...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431253266-qdwxtogk2ji-integrating-slack__01-for-slack.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="For Slack" caption=" " />
...
<Expandable title="What will Scrut Teammates be able to view?" default-open="false">
...
<Expandable title="What will Scrut Teammates be able to do?" default-open="false">
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431255095-rp0qdxcdtjb-integrating-slack__02-locate-the-slack-tile-and-click-integrate.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Locate the Slack tile and click Integrate" caption=" " />
5. On the Slack integration page, click **Connect** in the top-right corner.

<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431256914-5up1vfh9p1-integrating-slack__03-on-the-slack-integration-page-click-connect.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="On the Slack integration page, click Connect in the top-right corner" caption=" " />

### Step 2: Authenticate with Slack

6. Enter your workspace's Slack URL and click **Continue**.

<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431258676-rgmx96tmlf-integrating-slack__04-enter-your-workspaces-slack-url-and-click.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Enter your workspace's Slack URL and click Continue" caption=" " />
7. Enter your work email address and sign in to your Slack workspace.

<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431260909-pcmholoxuvg-integrating-slack__05-enter-your-work-email-address-and-sign-in-to.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Enter your work email address and sign in to your Slack workspace" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1786431253266-qdwxtogk2ji-integrating-slack__01-for-slack.png?fm=auto&auto=compress%2Cformat" width="800" height="600" alt="Note: You must have admin permissions in Slack to complete the authorization" caption=" " />
...
- **Reminders:** Send [employees timely reminders](https://help.scrut.io/docs/configuring-slack-reminders#1-employee-reminders) about incomplete security tasks directly in Slack.
- **Real-time alerts:** Receive [instant notifications](https://help.scrut.io/docs/configuring-slack-reminders#2-alerts) for critical events like Trust Vault requests, test and integration failures, comment mentions, and more.
- **Task Summaries:** Receive a direct message from Scrut with a [summary](https://help.scrut.io/docs/configuring-slack-reminders#3-personal-tasks) of your pending security tasks.
- **Digests:** Stay in the loop with a [Scrut digest](https://help.scrut.io/docs/configuring-slack-reminders#4-scrut-digest) that reflects your organization's overall compliance status.

### 2: Conduct Access Reviews

Include Slack in scope for Access Reviews to verify that user accounts are mapped to valid identities and that deprovisioned accounts are removed promptly. For guidance, refer to the [Access Reviews help documentation](https://help.scrut.io/docs/what-is-access-review).
...
Use the Scrut Teammates bot in Slack to [ask compliance and security questions](https://help.scrut.io/docs/scrut-teammates-slack-app) and get instant, contextual answers.
...
<Expandable title="1: What Slack data does Scrut collect?" default-open="false">
...
<Expandable title="2: How often does Scrut sync data from Slack?" default-open="false">
